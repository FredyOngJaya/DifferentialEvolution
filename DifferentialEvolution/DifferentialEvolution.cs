...
namespace DifferentialEvolution
{
    ...
    {
        // class members
        public delegate OutputFunction FunctionPointer(List<int>[] paras, InputStructure S_in);
    ...
    //        OptimizerOutput result = new OptimizerOutput();
    //        return result;
    //    }
    //}
    ...
    //public struct OutputFunction
    //{
    //    public int numberOfConstraints; // no. of constraints
    //    public double[] vectorConstraintArray; // constraint array
    //    public int numberOfObjective; // number of objectives (costs)
    //    public double[] vectorObjectiveArray; // objective array  

    //    public OutputFunction(int numberOfConstraint_, int numberOfObjective_)
    //    {
    //        numberOfConstraints = numberOfConstraint_;
    //        vectorConstraintArray = new double[numberOfConstraint_ + 1];
    //        numberOfObjective = numberOfObjective_;
    //        vectorObjectiveArray = new double[numberOfObjective];
    //    }
    //}

    //public struct InputStructure
    //{
    //    public int numberOfPopulation; // Number of population members
    //    public double weight; // DE-stepsize F_weight from interval [0, 2]
    //    public double crossOverProbability; // Crossover probability constant from interval [0, 1].
    //    public int numberOfParameterObjectiveFunction; // Number of parameters of the objective function.
    //    //*** note: these are not bound constraints!! ***//
    //    public double[] vectorLowerBound; // Vector of lower bounds FVr_minbound(1) ... FVr_minbound(I_D) of initial population.
    //    public double[] vectorUpperbound; // Vector of upper bounds FVr_maxbound(1) ... FVr_maxbound(I_D) of initial population.
    //    public bool useBoundConstraint; // true: use bounds as bound constraints, false: no bound constraints
    //    public int maxIteration; // maximum number of iterations (generations)
    //    public double valueToReach; // "Value To Reach" (stop when ofunc < F_VTR)
    //    public int strategy;
    //    public int intermediateOutput;
    //    public double[,] population;
    //    public double[] vectorBest;
    //}
